"""YOLO26-style detector with focus plugins and parallel contour branch."""
...
class YOLO26FocusFourier(nn.Module):
    ...
    def __init__(self, cfg: dict[str, Any]) -> None:
        ...
        self.backbone = YOLO26Backbone(cfg, plugin_router=router)
